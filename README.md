...
| Function / Component | RP2350 GPIO Pin | Pico 2 Physical Pin | Description |
| :--- | :--- | :--- | :--- |
| **I2C SDA** | **GP16** | **Pin 21** | Shared I2C Data Line (SSD1306 & Si5351) |
| **I2C SCL** | **GP17** | **Pin 22** | Shared I2C Clock Line (SSD1306 & Si5351) |
| **Page Button** | **GP18** | **Pin 24** | Cycle through active channels (0 to 2) |
| **Step Button** | **GP19** | **Pin 25** | Change tuning step size (0.1 Hz – 100 MHz) |
| **Save Button** | **GP20** | **Pin 26** | Commit working frequency to channel RAM |
| **Encoder Phase A** | **GP21** | **Pin 27** | Rotary encoder quadrature phase A or S1 |
| **Encoder Phase B** | **GP22** | **Pin 29** | Rotary encoder quadrature phase B or S2 |

---

## Quick Flashing via `.uf2` (No Compilation Needed)
