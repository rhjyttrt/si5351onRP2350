...
A high performance, 3 channel programmable frequency generator built for the **Raspberry Pi RP2350** microcontroller, **Si5351** clock generator, and **SSD1306** OLED display.
...
* **Step Button:** GP19 (Pico 2 Pin 25) | Change tuning step size (0.1 Hz to 100 MHz)
...
3. Under the **Tools** menu, configure your board settings as follows:

| Tools Menu Option | Required Setting |
| :--- | :--- |
...
| **USB Stack** | `Pico SDK` |
| **PSRAM Size** | `0MB/0Byte PSRAM` |

4. Select your active serial port and click **Upload**.
